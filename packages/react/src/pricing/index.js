  ...
  return (
    <div className="w-full md:w-1/2 relative z-0 px-8 md:px-0 md:py-16">
      <div className="bg-blue-900 text-white rounded-b md:rounded-b-none md:rounded-r shadow-lg overflow-hidden">
        ...
        <p className="text-center text-sm sm:text-md max-w-sm mx-auto mt-8 text-blue-200 px-8 lg:px-0">
          {props.description}
        </p>
...
//   )
// }
// Pricing.Copyright = props => {
//   return <p sx={{ m: 0 }} {...props} />
// }

applyPropertyControls(Pricing, {
  justifyContent: {
...
applyPropertyControls(Pricing.Pay, {
  sx: {
    type: ControlType.Style
  }
})
applyPropertyControls(Pricing.Enterprise, {
  children: {
    title: 'Text',
...
// applyPropertyControls(Pricing.Logo, linkControls)
// applyPropertyControls(Pricing.Link, linkControls)
